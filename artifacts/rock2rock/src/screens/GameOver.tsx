  ...
  return (
    ...
    >
      <div className={`absolute inset-0 bg-[radial-gradient(ellipse_at_center,${
        isWinner ? "rgba(168,85,247,0.3)" : "rgba(239,68,68,0.3)"
      }_0%,rgba(0,0,0,1)_80%)] pointer-events-none`} />
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        {isWinner && selectedAvatar && (
          <div className="relative w-48 h-48 mb-8 flex items-center justify-center">
            ...
            />
            <div className={`w-24 h-24 rounded-lg bg-gradient-to-br ${selectedAvatar.gradient} flex items-center justify-center text-5xl z-10 shadow-[0_0_30px_rgba(168,85,247,0.8)]`}>
              {selectedAvatar.emoji}
            </div>
          </div>
        )}

        <div className={`text-4xl font-black mb-12 tracking-[0.2em] ${isWinner ? 'text-purple-200' : 'text-red-300'}`}>
